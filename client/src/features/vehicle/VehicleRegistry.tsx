...
const VehicleRegistry: React.FC = () => {
  return (
    <div className="flex min-h-screen bg-[#f8f9ff] font-['Inter',sans-serif]">
      {/* SideNavBar (Shared Component) */}
      <aside className="fixed left-0 top-0 h-full w-[240px] bg-[#131b2e] flex flex-col py-4 gap-2 z-50">
        <div className="px-6 mb-8">
          <h1 className="font-headline-sm text-[20px] leading-[28px] font-bold text-white">TransitOps ERP</h1>
          <p className="text-[10px] uppercase tracking-widest text-[#7c839b]/60 font-semibold">Fleet Management</p>
        </div>
        <nav className="flex-1 space-y-1">
          <a className="flex items-center px-6 py-3 gap-3 text-[#7c839b]/70 hover:bg-[#d3e4fe]/10 transition-all duration-200 text-[13px]" href="#">
            <span className="material-symbols-outlined">dashboard</span>
            <span>Dashboard</span>
          </a>
          {/* Active Tab: Vehicles */}
          <a className="flex items-center px-6 py-3 gap-3 bg-[#2170e4] text-[#fefcff] border-l-2 border-[#0058be] text-[13px]" href="#">
      ...
      {/* Main Content Area */}
      <main className="ml-[240px] flex-1 flex flex-col min-h-screen w-[calc(100%-240px)]">
        {/* TopNavBar (Shared Component) */}
        <header className="w-full h-16 sticky top-0 bg-[#f8f9ff] z-40 border-b border-[#c6c6cd] flex justify-between items-center px-[32px] shadow-none">
          <div className="flex items-center gap-6 flex-1">
            <div className="relative w-full max-w-md">
              <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#76777d]">search</span>
              <input className="w-full bg-[#eff4ff] border-none rounded-lg pl-10 pr-4 py-2 text-[13px] focus:ring-2 focus:ring-[#0058be]/20" placeholder="Search vehicles, VINs, or operators..." type="text" />
            </div>
          </div>
          <div className="flex items-center gap-4">
            <button className="p-2 hover:bg-[#eff4ff] transition-colors rounded-full text-[#45464d]">
              <span className="material-symbols-outlined">notifications</span>
            </button>
            <button className="p-2 hover:bg-[#eff4ff] transition-colors rounded-full text-[#45464d]">
              <span className="material-symbols-outlined">settings</span>
            </button>
            <div className="h-8 w-8 rounded-full bg-[#d3e4fe] flex items-center justify-center overflow-hidden border border-[#c6c6cd]">
              <img className="w-full h-full object-cover" alt="User Profile" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBLLRbuh66d0GFgL751ltZT4bGMpa5YmFZTq9sIMwcZHnfbBYFjen_Yasq3Ss_EoNcusDmU0sSZE_or3y5Aw-OMs1fDjPt3Vidxryr5uPppU-ViE6S7zbUZwo-NFMJ_4eoxNDI1mBIhDQWXSgeWNPEuDqV8NqK9LMQiviNE_RwtS1J3HXqJd767EyiMXDIf73a4rtKg-QOJz5V4xd2SZ8gdGS7X37139Ygb-QyXkjZwSBJ_t-q7YLrcBYApg3ZjbhcZregfjKFXD3I" />
            </div>
          </div>
        </header>
        ...
        <div className="p-[32px] space-y-6 max-w-[1600px] mx-auto w-full">
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-3 bg-[#f8f9ff] border border-[#c6c6cd] p-5 rounded-xl">
          ...
          {/* Filters Section */}
          <div className="bg-[#eff4ff] p-4 rounded-xl flex items-center justify-between gap-4 border border-[#c6c6cd]/50">
          ...
          <div className="grid grid-cols-12 gap-6 pb-[32px]">
            <div className="col-span-8 bg-[#f8f9ff] border border-[#c6c6cd] rounded-xl p-6">
            ...
            <div className="col-span-4 bg-[#131b2e] text-[#7c839b] p-6 rounded-xl relative overflow-hidden">
              ...
              {/* Subtle Abstract Shape for Flair */}
